...
export default function LabPartnerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      {/* Lab Partner Header */}
      <div className="bg-gradient-to-r from-cyan-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">Lab Partner Dashboard</h1>
              <p className="text-cyan-100">SmartLab Jaipur Central</p>
            </div>
            <div className="flex gap-3">
              <Link href="/lab-partner/packages" className="px-4 py-2 bg-white/20 rounded-xl hover:bg-white/30 transition-smooth text-sm font-medium">
                Packages
              </Link>
              <Link href="/lab-partner/dispatch" className="px-4 py-2 bg-white/20 rounded-xl hover:bg-white/30 transition-smooth text-sm font-medium">
                Dispatch
              </Link>
              <Link href="/lab-partner/fleet" className="px-4 py-2 bg-white/20 rounded-xl hover:bg-white/30 transition-smooth text-sm font-medium">
                Fleet
              </Link>
              <Link href="/lab-partner/reports" className="px-4 py-2 bg-white/20 rounded-xl hover:bg-white/30 transition-smooth text-sm font-medium">
                Reports
              </Link>
            </div>
          </div>
